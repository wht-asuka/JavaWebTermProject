        ...
        try {
            ...
            for(FileItem fileItem : list){
                if (fileItem.isFormField()) {//是文本字段
                    ...
                    }else if (fileItemName.equals("proauthor")) {
                        params.add(fileItemValue);//参数传入 proauthor
                    ...
                    String upload_dir = request.getSession().getServletContext().getRealPath("/upload");//获取服务器端 /upload 路径
